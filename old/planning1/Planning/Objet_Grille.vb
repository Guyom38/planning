...
Public Class Objet_Grille
    ...
    Public VERROUS(DimensionX, DimensionY) As Boolean
        ...
        For y = 0 To DimensionY - 1
            ...
            For x = 0 To DimensionX - 1
                ...
                ElseIf y = 0 And x > 0 Then
                    ...
                    If gr Then
                        CELLULES(x, 0) = New Objet_Cellule(x, 0, {LISTE_JOURS(((x - 1) / 2))}) With {.FusionX = 2}
                    Else
                ...
                ElseIf x > 0 And y > 0 Then
                    CELLULES(x, y) = New Objet_Cellule(x, y, {""}) With {.FusionX = 1}
            ...
            For y = 0 To DimensionY - 1
                If CELLULES(x, y) IsNot Nothing Then
                    If CELLULES(x, y).Init Then
                        ...
                        If Not CELLULES(x, y).FusionX = 1 Then
